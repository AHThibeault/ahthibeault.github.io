...
Experiments 1 and 2 dealt with characterizing, simulating, and testing the PV-to-battery stage. They are summarized on the rest of this page. The reports for the power converter design experiments were too long to justify rewriting into markdown, so they are included in all of their gory detail as pdfs here:
...
The completed system operating and powering a lightbulb on demo day is shown below.
